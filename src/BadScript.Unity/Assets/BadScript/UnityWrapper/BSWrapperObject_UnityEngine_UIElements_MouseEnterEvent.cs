...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseEnterEvent : BSWrapperObject < MouseEnterEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseEnterEvent( MouseEnterEvent obj ) : base( obj )
        {
