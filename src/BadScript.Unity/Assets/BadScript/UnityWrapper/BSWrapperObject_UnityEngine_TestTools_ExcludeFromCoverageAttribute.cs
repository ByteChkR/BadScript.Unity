...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_TestTools_ExcludeFromCoverageAttribute : BSWrapperObject <
            ExcludeFromCoverageAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_TestTools_ExcludeFromCoverageAttribute( ExcludeFromCoverageAttribute obj ) :
            base( obj )
        {
