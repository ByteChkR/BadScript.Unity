...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_WheelJoint2D : BSWrapperObject < WheelJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_WheelJoint2D( WheelJoint2D obj ) : base( obj )
        {
            m_Properties["suspension"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_JointSuspension2D( m_InternalObject.suspension ),
                x => m_InternalObject.suspension = WrapperHelper.UnwrapObject < JointSuspension2D >( x ) );
            ...
            m_Properties["jointLinearSpeed"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.jointLinearSpeed ),
                null );
            ...
            m_Properties["jointAngle"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.jointAngle ),
                null );
            ...
            m_Properties["GetMotorTorque"] = new BSFunctionReference(
                new BSFunction(
                    "function GetMotorTorque(timeStep)",
                    a => new BSObject(
                        ( decimal ) m_InternalObject.GetMotorTorque( WrapperHelper.UnwrapObject < float >( a[0] ) ) ),
                    1 ) );
