...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseLeaveEvent : BSWrapperObject < MouseLeaveEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseLeaveEvent( MouseLeaveEvent obj ) : base( obj )
        {
