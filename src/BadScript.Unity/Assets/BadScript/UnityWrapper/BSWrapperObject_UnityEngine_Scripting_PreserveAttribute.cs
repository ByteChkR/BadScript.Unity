...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Scripting_PreserveAttribute : BSWrapperObject < PreserveAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Scripting_PreserveAttribute( PreserveAttribute obj ) : base( obj )
        {
