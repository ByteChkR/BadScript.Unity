...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_HelpURLAttribute : BSWrapperObject < HelpURLAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_HelpURLAttribute( HelpURLAttribute obj ) : base( obj )
        {
