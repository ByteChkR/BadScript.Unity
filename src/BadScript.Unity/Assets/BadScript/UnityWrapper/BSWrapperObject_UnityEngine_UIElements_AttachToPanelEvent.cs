...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_AttachToPanelEvent : BSWrapperObject < AttachToPanelEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_AttachToPanelEvent( AttachToPanelEvent obj ) : base( obj )
        {
