...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerCaptureEvent : BSWrapperObject < PointerCaptureEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerCaptureEvent( PointerCaptureEvent obj ) : base( obj )
        {
