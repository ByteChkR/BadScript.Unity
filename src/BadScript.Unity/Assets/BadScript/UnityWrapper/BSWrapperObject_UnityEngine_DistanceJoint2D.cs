...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_DistanceJoint2D : BSWrapperObject < DistanceJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_DistanceJoint2D( DistanceJoint2D obj ) : base( obj )
        {
            m_Properties["autoConfigureDistance"] = new BSReflectionReference(
                () => m_InternalObject.autoConfigureDistance ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.autoConfigureDistance = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["maxDistanceOnly"] = new BSReflectionReference(
                () => m_InternalObject.maxDistanceOnly ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.maxDistanceOnly = WrapperHelper.UnwrapObject < bool >( x ) );
