...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_ScaleConstraint : BSWrapperObject < ScaleConstraint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_ScaleConstraint( ScaleConstraint obj ) : base( obj )
        {
            ...
            m_Properties["scaleAtRest"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.scaleAtRest ),
                x => m_InternalObject.scaleAtRest = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["scaleOffset"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.scaleOffset ),
                x => m_InternalObject.scaleOffset = WrapperHelper.UnwrapObject < Vector3 >( x ) );
