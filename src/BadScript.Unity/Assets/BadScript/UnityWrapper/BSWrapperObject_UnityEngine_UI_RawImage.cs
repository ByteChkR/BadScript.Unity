...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_RawImage : BSWrapperObject < RawImage >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_RawImage( RawImage obj ) : base( obj )
        {
            ...
            m_Properties["texture"] = new BSReflectionReference(
                ...
                x => m_InternalObject.texture = WrapperHelper.UnwrapObject < Texture >( x ) );

            m_Properties["uvRect"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Rect( m_InternalObject.uvRect ),
                x => m_InternalObject.uvRect = WrapperHelper.UnwrapObject < Rect >( x ) );
