...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_ExitGUIException : BSWrapperObject < ExitGUIException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ExitGUIException( ExitGUIException obj ) : base( obj )
        {
