...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerLeaveEvent : BSWrapperObject < PointerLeaveEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerLeaveEvent( PointerLeaveEvent obj ) : base( obj )
        {
