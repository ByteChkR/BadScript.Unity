...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_FixedJoint2D : BSWrapperObject < FixedJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_FixedJoint2D( FixedJoint2D obj ) : base( obj )
        {
