...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_EventSystems_TouchInputModule : BSWrapperObject < TouchInputModule >

    {
        #region Public

        public BSWrapperObject_UnityEngine_EventSystems_TouchInputModule( TouchInputModule obj ) : base( obj )
        {
            m_Properties["allowActivationOnStandalone"] = new BSReflectionReference(
