...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UnityException : BSWrapperObject < UnityException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UnityException( UnityException obj ) : base( obj )
        {
