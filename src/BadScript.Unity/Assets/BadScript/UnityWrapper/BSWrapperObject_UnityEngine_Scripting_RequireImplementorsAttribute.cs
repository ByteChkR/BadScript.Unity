...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Scripting_RequireImplementorsAttribute : BSWrapperObject <
            RequireImplementorsAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Scripting_RequireImplementorsAttribute( RequireImplementorsAttribute obj ) :
            base( obj )
        {
