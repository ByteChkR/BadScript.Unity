...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_ImageEffectOpaque : BSWrapperObject < ImageEffectOpaque >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ImageEffectOpaque( ImageEffectOpaque obj ) : base( obj )
        {
