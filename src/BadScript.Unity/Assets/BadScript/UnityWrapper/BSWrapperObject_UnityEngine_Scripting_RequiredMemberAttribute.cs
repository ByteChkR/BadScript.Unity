...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Scripting_RequiredMemberAttribute : BSWrapperObject < RequiredMemberAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Scripting_RequiredMemberAttribute( RequiredMemberAttribute obj ) : base(
            obj )
        {
