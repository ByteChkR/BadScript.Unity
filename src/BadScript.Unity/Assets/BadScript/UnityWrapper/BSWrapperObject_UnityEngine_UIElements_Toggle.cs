...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_Toggle : BSWrapperObject < Toggle >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_Toggle( Toggle obj ) : base( obj )
        {
