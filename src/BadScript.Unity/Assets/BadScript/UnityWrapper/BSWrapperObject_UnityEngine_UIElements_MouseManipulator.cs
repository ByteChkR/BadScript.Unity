...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseManipulator : BSWrapperObject < MouseManipulator >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseManipulator( MouseManipulator obj ) : base( obj )
        {
