...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Internal_ExcludeFromDocsAttribute : BSWrapperObject < ExcludeFromDocsAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Internal_ExcludeFromDocsAttribute( ExcludeFromDocsAttribute obj ) : base(
            obj )
        {
