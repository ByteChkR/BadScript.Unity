...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_WSA_AppCallbackItem : BSWrapperObject < AppCallbackItem >

    {
        #region Public

        public BSWrapperObject_UnityEngine_WSA_AppCallbackItem( AppCallbackItem obj ) : base( obj )
        {
