...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_PointerStationaryEvent : BSWrapperObject < PointerStationaryEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerStationaryEvent( PointerStationaryEvent obj ) : base( obj )
        {
