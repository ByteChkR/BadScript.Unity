...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerOutEvent : BSWrapperObject < PointerOutEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerOutEvent( PointerOutEvent obj ) : base( obj )
        {
