...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_HingeJoint : BSWrapperObject < HingeJoint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_HingeJoint( HingeJoint obj ) : base( obj )
        {
            m_Properties["motor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_JointMotor( m_InternalObject.motor ),
                x => m_InternalObject.motor = WrapperHelper.UnwrapObject < JointMotor >( x ) );

            m_Properties["limits"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_JointLimits( m_InternalObject.limits ),
                x => m_InternalObject.limits = WrapperHelper.UnwrapObject < JointLimits >( x ) );

            m_Properties["spring"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_JointSpring( m_InternalObject.spring ),
                x => m_InternalObject.spring = WrapperHelper.UnwrapObject < JointSpring >( x ) );
            ...
            m_Properties["useSpring"] = new BSReflectionReference(
                () => m_InternalObject.useSpring ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.useSpring = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["velocity"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.velocity ),
                null );
