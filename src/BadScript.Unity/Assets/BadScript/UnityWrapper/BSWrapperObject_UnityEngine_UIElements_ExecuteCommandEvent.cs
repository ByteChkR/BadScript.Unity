...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ExecuteCommandEvent : BSWrapperObject < ExecuteCommandEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ExecuteCommandEvent( ExecuteCommandEvent obj ) : base( obj )
        {
