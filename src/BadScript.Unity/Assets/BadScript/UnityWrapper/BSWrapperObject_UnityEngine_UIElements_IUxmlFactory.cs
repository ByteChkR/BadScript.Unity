...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_IUxmlFactory : BSWrapperObject < IUxmlFactory >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_IUxmlFactory( IUxmlFactory obj ) : base( obj )
        {
