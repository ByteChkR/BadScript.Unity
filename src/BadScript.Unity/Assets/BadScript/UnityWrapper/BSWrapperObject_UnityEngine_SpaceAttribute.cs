...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SpaceAttribute : BSWrapperObject < SpaceAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SpaceAttribute( SpaceAttribute obj ) : base( obj )
        {
