...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_PlayerPrefsException : BSWrapperObject < PlayerPrefsException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_PlayerPrefsException( PlayerPrefsException obj ) : base( obj )
        {
