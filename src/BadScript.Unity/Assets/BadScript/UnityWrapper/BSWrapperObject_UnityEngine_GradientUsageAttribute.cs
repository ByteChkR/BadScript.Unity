...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_GradientUsageAttribute : BSWrapperObject < GradientUsageAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_GradientUsageAttribute( GradientUsageAttribute obj ) : base( obj )
        {
