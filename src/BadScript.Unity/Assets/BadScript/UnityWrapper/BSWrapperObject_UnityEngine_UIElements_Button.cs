...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_Button : BSWrapperObject < Button >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_Button( Button obj ) : base( obj )
        {
            m_Properties["clickable"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_Clickable( m_InternalObject.clickable ),
                x => m_InternalObject.clickable = WrapperHelper.UnwrapObject < Clickable >( x ) );
