...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_SliderInt : BSWrapperObject < SliderInt >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_SliderInt( SliderInt obj ) : base( obj )
        {
            ...
            m_Properties["lowValue"] = new BSReflectionReference(
                ...
                x => m_InternalObject.lowValue = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["highValue"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.highValue ),
                x => m_InternalObject.highValue = WrapperHelper.UnwrapObject < int >( x ) );
