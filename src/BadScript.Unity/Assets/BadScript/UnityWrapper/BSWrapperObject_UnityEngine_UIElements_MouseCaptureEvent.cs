...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseCaptureEvent : BSWrapperObject < MouseCaptureEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseCaptureEvent( MouseCaptureEvent obj ) : base( obj )
        {
