...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DragUpdatedEvent : BSWrapperObject < DragUpdatedEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DragUpdatedEvent( DragUpdatedEvent obj ) : base( obj )
        {
