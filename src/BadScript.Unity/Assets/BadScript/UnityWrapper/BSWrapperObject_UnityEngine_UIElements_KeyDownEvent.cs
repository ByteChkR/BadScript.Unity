...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_KeyDownEvent : BSWrapperObject < KeyDownEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_KeyDownEvent( KeyDownEvent obj ) : base( obj )
        {
