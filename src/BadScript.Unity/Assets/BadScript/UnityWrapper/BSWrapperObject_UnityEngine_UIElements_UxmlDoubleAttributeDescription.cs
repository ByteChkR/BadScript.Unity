...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_UxmlDoubleAttributeDescription : BSWrapperObject <
            UxmlDoubleAttributeDescription >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlDoubleAttributeDescription(
            UxmlDoubleAttributeDescription obj ) : base( obj )
        {
            ...
            m_Properties["defaultValue"] = new BSReflectionReference(
                ...
                x => m_InternalObject.defaultValue = WrapperHelper.UnwrapObject < double >( x ) );
