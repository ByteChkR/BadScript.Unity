...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Networking_DownloadHandlerScript : BSWrapperObject < DownloadHandlerScript >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_DownloadHandlerScript( DownloadHandlerScript obj ) : base( obj )
        {
