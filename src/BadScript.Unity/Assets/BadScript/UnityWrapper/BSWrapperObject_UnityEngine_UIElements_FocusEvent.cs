...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_FocusEvent : BSWrapperObject < FocusEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_FocusEvent( FocusEvent obj ) : base( obj )
        {
