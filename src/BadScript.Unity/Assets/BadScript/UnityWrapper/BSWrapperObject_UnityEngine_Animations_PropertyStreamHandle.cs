...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_PropertyStreamHandle : BSWrapperObject < PropertyStreamHandle >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_PropertyStreamHandle( PropertyStreamHandle obj ) : base( obj )
        {
            ...
            m_Properties["GetReadMask"] = new BSFunctionReference(
                new BSFunction(
                    "function GetReadMask(stream)",
                    a => m_InternalObject.GetReadMask( WrapperHelper.UnwrapObject < AnimationStream >( a[0] ) )
                        ? BSObject.One
                        : BSObject.Zero,
                    1 ) );
