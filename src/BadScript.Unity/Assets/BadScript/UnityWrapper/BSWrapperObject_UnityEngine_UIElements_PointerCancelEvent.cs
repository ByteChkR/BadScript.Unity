...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerCancelEvent : BSWrapperObject < PointerCancelEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerCancelEvent( PointerCancelEvent obj ) : base( obj )
        {
