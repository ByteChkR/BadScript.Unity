...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Assertions_AssertionException : BSWrapperObject < AssertionException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Assertions_AssertionException( AssertionException obj ) : base( obj )
        {
