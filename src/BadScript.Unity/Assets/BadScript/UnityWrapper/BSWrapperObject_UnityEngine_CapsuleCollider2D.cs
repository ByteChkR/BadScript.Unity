...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CapsuleCollider2D : BSWrapperObject < CapsuleCollider2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CapsuleCollider2D( CapsuleCollider2D obj ) : base( obj )
        {
