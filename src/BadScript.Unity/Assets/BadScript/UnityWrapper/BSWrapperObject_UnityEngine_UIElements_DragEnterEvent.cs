...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DragEnterEvent : BSWrapperObject < DragEnterEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DragEnterEvent( DragEnterEvent obj ) : base( obj )
        {
