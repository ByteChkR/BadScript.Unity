...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CustomYieldInstruction : BSWrapperObject < CustomYieldInstruction >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CustomYieldInstruction( CustomYieldInstruction obj ) : base( obj )
        {
