...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SpringJoint2D : BSWrapperObject < SpringJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SpringJoint2D( SpringJoint2D obj ) : base( obj )
        {
