...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_TrailRenderer : BSWrapperObject < TrailRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_TrailRenderer( TrailRenderer obj ) : base( obj )
        {
            ...
            m_Properties["autodestruct"] = new BSReflectionReference(
                () => m_InternalObject.autodestruct ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.autodestruct = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["emitting"] = new BSReflectionReference(
                () => m_InternalObject.emitting ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.emitting = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["minVertexDistance"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.minVertexDistance ),
                x => m_InternalObject.minVertexDistance = WrapperHelper.UnwrapObject < float >( x ) );
