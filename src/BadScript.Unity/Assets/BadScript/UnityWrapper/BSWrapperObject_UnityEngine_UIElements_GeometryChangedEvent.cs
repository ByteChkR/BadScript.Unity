...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_GeometryChangedEvent : BSWrapperObject < GeometryChangedEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_GeometryChangedEvent( GeometryChangedEvent obj ) : base( obj )
        {
            m_Properties["oldRect"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Rect( m_InternalObject.oldRect ),
                null );

            m_Properties["newRect"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Rect( m_InternalObject.newRect ),
                null );
