...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_FrictionJoint2D : BSWrapperObject < FrictionJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_FrictionJoint2D( FrictionJoint2D obj ) : base( obj )
        {
