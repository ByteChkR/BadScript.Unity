...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_HelpBox : BSWrapperObject < HelpBox >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_HelpBox( HelpBox obj ) : base( obj )
        {
