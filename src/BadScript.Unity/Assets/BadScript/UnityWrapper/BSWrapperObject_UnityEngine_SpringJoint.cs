...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SpringJoint : BSWrapperObject < SpringJoint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SpringJoint( SpringJoint obj ) : base( obj )
        {
            ...
            m_Properties["tolerance"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.tolerance ),
                x => m_InternalObject.tolerance = WrapperHelper.UnwrapObject < float >( x ) );
