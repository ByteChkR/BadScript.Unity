...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UnassignedReferenceException : BSWrapperObject < UnassignedReferenceException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UnassignedReferenceException( UnassignedReferenceException obj ) : base(
            obj )
        {
