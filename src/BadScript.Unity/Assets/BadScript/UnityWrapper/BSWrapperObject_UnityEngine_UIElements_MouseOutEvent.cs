...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseOutEvent : BSWrapperObject < MouseOutEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseOutEvent( MouseOutEvent obj ) : base( obj )
        {
