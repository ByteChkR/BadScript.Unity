...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_DirectionalLight : BSWrapperObject <
            DirectionalLight >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_DirectionalLight( DirectionalLight obj ) :
            base( obj )
        {
            ...
            m_Properties["penumbraWidthRadian"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.penumbraWidthRadian ),
                x => m_InternalObject.penumbraWidthRadian = WrapperHelper.UnwrapObject < float >( x ) );
