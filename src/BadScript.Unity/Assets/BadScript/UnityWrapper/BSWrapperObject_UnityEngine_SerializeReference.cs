...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SerializeReference : BSWrapperObject < SerializeReference >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SerializeReference( SerializeReference obj ) : base( obj )
        {
