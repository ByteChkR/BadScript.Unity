...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CompositeCollider2D : BSWrapperObject < CompositeCollider2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CompositeCollider2D( CompositeCollider2D obj ) : base( obj )
        {
            m_Properties["vertexDistance"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.vertexDistance ),
                x => m_InternalObject.vertexDistance = WrapperHelper.UnwrapObject < float >( x ) );
            ...
            m_Properties["offsetDistance"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.offsetDistance ),
                x => m_InternalObject.offsetDistance = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["pathCount"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.pathCount ),
                null );
            ...
            m_Properties["GetPathPointCount"] = new BSFunctionReference(
                new BSFunction(
                    "function GetPathPointCount(index)",
                    a => new BSObject(
                        ( decimal ) m_InternalObject.GetPathPointCount( WrapperHelper.UnwrapObject < int >( a[0] ) ) ),
                    1 ) );
