...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Networking_DownloadHandlerBuffer : BSWrapperObject < DownloadHandlerBuffer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_DownloadHandlerBuffer( DownloadHandlerBuffer obj ) : base( obj )
        {
