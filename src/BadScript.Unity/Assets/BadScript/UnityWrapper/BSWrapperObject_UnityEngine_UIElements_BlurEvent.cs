...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_BlurEvent : BSWrapperObject < BlurEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_BlurEvent( BlurEvent obj ) : base( obj )
        {
