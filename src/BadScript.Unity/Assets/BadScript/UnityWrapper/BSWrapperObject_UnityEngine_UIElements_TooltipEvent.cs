...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_TooltipEvent : BSWrapperObject < TooltipEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_TooltipEvent( TooltipEvent obj ) : base( obj )
        {
