...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_Foldout : BSWrapperObject < Foldout >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_Foldout( Foldout obj ) : base( obj )
        {
            ...
            m_Properties["value"] = new BSReflectionReference(
                () => m_InternalObject.value ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.value = WrapperHelper.UnwrapObject < bool >( x ) );
