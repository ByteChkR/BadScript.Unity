...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerDownEvent : BSWrapperObject < PointerDownEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerDownEvent( PointerDownEvent obj ) : base( obj )
        {
