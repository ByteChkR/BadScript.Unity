...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MinMaxSlider : BSWrapperObject < MinMaxSlider >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MinMaxSlider( MinMaxSlider obj ) : base( obj )
        {
            ...
            m_Properties["value"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.value ),
                x => m_InternalObject.value = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["range"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.range ),
                null );

            m_Properties["lowLimit"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.lowLimit ),
                x => m_InternalObject.lowLimit = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["highLimit"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.highLimit ),
                x => m_InternalObject.highLimit = WrapperHelper.UnwrapObject < float >( x ) );
