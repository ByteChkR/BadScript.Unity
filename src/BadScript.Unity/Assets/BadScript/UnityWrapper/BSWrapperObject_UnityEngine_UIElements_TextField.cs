...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_TextField : BSWrapperObject < TextField >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_TextField( TextField obj ) : base( obj )
        {
            ...
            m_Properties["value"] = new BSReflectionReference(
                () => new BSObject( m_InternalObject.value ),
                x => m_InternalObject.value = WrapperHelper.UnwrapObject < string >( x ) );
            ...
            m_Properties["isReadOnly"] = new BSReflectionReference(
                ...
                x => m_InternalObject.isReadOnly = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["maxLength"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxLength ),
                x => m_InternalObject.maxLength = WrapperHelper.UnwrapObject < int >( x ) );
            ...
            m_Properties["isDelayed"] = new BSReflectionReference(
                () => m_InternalObject.isDelayed ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.isDelayed = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["maskChar"] = new BSReflectionReference(
                () => new BSWrapperObject_System_Char( m_InternalObject.maskChar ),
                x => m_InternalObject.maskChar = WrapperHelper.UnwrapObject < char >( x ) );
