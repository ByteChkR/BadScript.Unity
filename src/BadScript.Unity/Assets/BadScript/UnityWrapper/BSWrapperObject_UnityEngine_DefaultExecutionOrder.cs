...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_DefaultExecutionOrder : BSWrapperObject < DefaultExecutionOrder >

    {
        #region Public

        public BSWrapperObject_UnityEngine_DefaultExecutionOrder( DefaultExecutionOrder obj ) : base( obj )
        {
