...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_GridLayoutGroup : BSWrapperObject < GridLayoutGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_GridLayoutGroup( GridLayoutGroup obj ) : base( obj )
        {
            m_Properties["cellSize"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.cellSize ),
                x => m_InternalObject.cellSize = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["spacing"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.spacing ),
                x => m_InternalObject.spacing = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["constraintCount"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.constraintCount ),
                x => m_InternalObject.constraintCount = WrapperHelper.UnwrapObject < int >( x ) );
