...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_TargetJoint2D : BSWrapperObject < TargetJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_TargetJoint2D( TargetJoint2D obj ) : base( obj )
        {
            ...
            m_Properties["target"] = new BSReflectionReference(
                ...
                x => m_InternalObject.target = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["autoConfigureTarget"] = new BSReflectionReference(
                () => m_InternalObject.autoConfigureTarget ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.autoConfigureTarget = WrapperHelper.UnwrapObject < bool >( x ) );
