...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_HingeJoint2D : BSWrapperObject < HingeJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_HingeJoint2D( HingeJoint2D obj ) : base( obj )
        {
            ...
            m_Properties["limits"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_JointAngleLimits2D( m_InternalObject.limits ),
                x => m_InternalObject.limits = WrapperHelper.UnwrapObject < JointAngleLimits2D >( x ) );
