...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_ToggleGroup : BSWrapperObject < ToggleGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_ToggleGroup( ToggleGroup obj ) : base( obj )
        {
            m_Properties["allowSwitchOff"] = new BSReflectionReference(
                () => m_InternalObject.allowSwitchOff ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.allowSwitchOff = WrapperHelper.UnwrapObject < bool >( x ) );
