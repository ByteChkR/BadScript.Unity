...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Scripting_RequireAttributeUsagesAttribute : BSWrapperObject <
            RequireAttributeUsagesAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Scripting_RequireAttributeUsagesAttribute(
            RequireAttributeUsagesAttribute obj ) : base( obj )
        {
