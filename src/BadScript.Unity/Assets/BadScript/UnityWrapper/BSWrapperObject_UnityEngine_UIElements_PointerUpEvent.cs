...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerUpEvent : BSWrapperObject < PointerUpEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerUpEvent( PointerUpEvent obj ) : base( obj )
        {
