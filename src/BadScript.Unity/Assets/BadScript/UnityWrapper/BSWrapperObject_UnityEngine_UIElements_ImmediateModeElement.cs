...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ImmediateModeElement : BSWrapperObject < ImmediateModeElement >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ImmediateModeElement( ImmediateModeElement obj ) : base( obj )
        {
