...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_IResolvedStyle : BSWrapperObject < IResolvedStyle >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_IResolvedStyle( IResolvedStyle obj ) : base( obj )
        {
            ...
            m_Properties["backgroundImage"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_Background( m_InternalObject.backgroundImage ),
                null );

            m_Properties["borderBottomColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.borderBottomColor ),
                null );
            ...
            m_Properties["borderLeftColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.borderLeftColor ),
                null );
            ...
            m_Properties["borderRightColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.borderRightColor ),
                null );
            ...
            m_Properties["borderTopColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.borderTopColor ),
                null );
            ...
            m_Properties["flexBasis"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_StyleFloat( m_InternalObject.flexBasis ),
                null );
            ...
            m_Properties["maxHeight"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_StyleFloat( m_InternalObject.maxHeight ),
                null );

            m_Properties["maxWidth"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_StyleFloat( m_InternalObject.maxWidth ),
                null );

            m_Properties["minHeight"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_StyleFloat( m_InternalObject.minHeight ),
                null );

            m_Properties["minWidth"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_StyleFloat( m_InternalObject.minWidth ),
                null );
            ...
            m_Properties["unityFont"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Font( m_InternalObject.unityFont ),
                null );

            m_Properties["unitySliceBottom"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.unitySliceBottom ),
                null );

            m_Properties["unitySliceLeft"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.unitySliceLeft ),
                null );

            m_Properties["unitySliceRight"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.unitySliceRight ),
                null );

            m_Properties["unitySliceTop"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.unitySliceTop ),
                null );
