...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_CustomStyleResolvedEvent : BSWrapperObject < CustomStyleResolvedEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_CustomStyleResolvedEvent( CustomStyleResolvedEvent obj ) : base(
            obj )
        {
