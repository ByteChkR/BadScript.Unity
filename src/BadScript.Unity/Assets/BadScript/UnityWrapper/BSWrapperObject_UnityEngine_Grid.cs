...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Grid : BSWrapperObject < Grid >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Grid( Grid obj ) : base( obj )
        {
            m_Properties["cellSize"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.cellSize ),
                x => m_InternalObject.cellSize = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["cellGap"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.cellGap ),
                x => m_InternalObject.cellGap = WrapperHelper.UnwrapObject < Vector3 >( x ) );
