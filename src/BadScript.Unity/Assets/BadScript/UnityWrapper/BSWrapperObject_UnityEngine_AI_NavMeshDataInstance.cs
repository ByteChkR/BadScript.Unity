...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_AI_NavMeshDataInstance : BSWrapperObject < NavMeshDataInstance >

    {
        #region Public

        public BSWrapperObject_UnityEngine_AI_NavMeshDataInstance( NavMeshDataInstance obj ) : base( obj )
        {
