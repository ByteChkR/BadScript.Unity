...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_GraphicRaycaster : BSWrapperObject < GraphicRaycaster >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_GraphicRaycaster( GraphicRaycaster obj ) : base( obj )
        {
            ...
            m_Properties["ignoreReversedGraphics"] = new BSReflectionReference(
                () => m_InternalObject.ignoreReversedGraphics ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.ignoreReversedGraphics = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["blockingMask"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_LayerMask( m_InternalObject.blockingMask ),
                x => m_InternalObject.blockingMask = WrapperHelper.UnwrapObject < LayerMask >( x ) );
