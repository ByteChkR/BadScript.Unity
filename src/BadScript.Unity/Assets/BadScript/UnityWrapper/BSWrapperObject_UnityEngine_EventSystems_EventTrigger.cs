...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_EventSystems_EventTrigger : BSWrapperObject < EventTrigger >

    {
        #region Public

        public BSWrapperObject_UnityEngine_EventSystems_EventTrigger( EventTrigger obj ) : base( obj )
        {
