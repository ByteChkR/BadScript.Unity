...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_TwoPaneSplitView : BSWrapperObject < TwoPaneSplitView >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_TwoPaneSplitView( TwoPaneSplitView obj ) : base( obj )
        {
            m_Properties["fixedPane"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_VisualElement( m_InternalObject.fixedPane ),
                null );

            m_Properties["flexedPane"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_VisualElement( m_InternalObject.flexedPane ),
                null );

            m_Properties["fixedPaneIndex"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.fixedPaneIndex ),
                x => m_InternalObject.fixedPaneIndex = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["fixedPaneInitialDimension"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.fixedPaneInitialDimension ),
                x => m_InternalObject.fixedPaneInitialDimension = WrapperHelper.UnwrapObject < float >( x ) );
