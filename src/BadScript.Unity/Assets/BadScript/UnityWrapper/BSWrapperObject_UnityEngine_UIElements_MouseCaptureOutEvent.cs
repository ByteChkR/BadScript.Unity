...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseCaptureOutEvent : BSWrapperObject < MouseCaptureOutEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseCaptureOutEvent( MouseCaptureOutEvent obj ) : base( obj )
        {
            m_Properties["relatedTarget"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_IEventHandler( m_InternalObject.relatedTarget ),
                null );
