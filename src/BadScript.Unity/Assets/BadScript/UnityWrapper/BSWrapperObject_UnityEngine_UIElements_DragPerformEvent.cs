...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DragPerformEvent : BSWrapperObject < DragPerformEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DragPerformEvent( DragPerformEvent obj ) : base( obj )
        {
