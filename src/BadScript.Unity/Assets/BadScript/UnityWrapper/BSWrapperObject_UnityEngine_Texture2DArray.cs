...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Texture2DArray : BSWrapperObject < Texture2DArray >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Texture2DArray( Texture2DArray obj ) : base( obj )
        {
