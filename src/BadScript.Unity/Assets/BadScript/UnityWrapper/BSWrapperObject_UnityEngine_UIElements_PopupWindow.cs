...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PopupWindow : BSWrapperObject < PopupWindow >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PopupWindow( PopupWindow obj ) : base( obj )
        {
