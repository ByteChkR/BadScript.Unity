...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_Outline : BSWrapperObject < Outline >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_Outline( Outline obj ) : base( obj )
        {
            m_Properties["effectColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.effectColor ),
                x => m_InternalObject.effectColor = WrapperHelper.UnwrapObject < Color >( x ) );

            m_Properties["effectDistance"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.effectDistance ),
                x => m_InternalObject.effectDistance = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["useGraphicAlpha"] = new BSReflectionReference(
                () => m_InternalObject.useGraphicAlpha ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.useGraphicAlpha = WrapperHelper.UnwrapObject < bool >( x ) );
