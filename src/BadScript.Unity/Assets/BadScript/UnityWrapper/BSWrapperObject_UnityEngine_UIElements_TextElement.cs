...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_TextElement : BSWrapperObject < TextElement >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_TextElement( TextElement obj ) : base( obj )
        {
