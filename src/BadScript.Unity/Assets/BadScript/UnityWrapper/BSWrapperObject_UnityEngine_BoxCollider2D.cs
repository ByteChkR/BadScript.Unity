...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_BoxCollider2D : BSWrapperObject < BoxCollider2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_BoxCollider2D( BoxCollider2D obj ) : base( obj )
        {
