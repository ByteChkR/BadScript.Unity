...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseDownEvent : BSWrapperObject < MouseDownEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseDownEvent( MouseDownEvent obj ) : base( obj )
        {
