...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_PropertyAttribute : BSWrapperObject < PropertyAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_PropertyAttribute( PropertyAttribute obj ) : base( obj )
        {
