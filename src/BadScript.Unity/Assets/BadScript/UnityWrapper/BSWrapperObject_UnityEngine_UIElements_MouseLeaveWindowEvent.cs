...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_MouseLeaveWindowEvent : BSWrapperObject < MouseLeaveWindowEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseLeaveWindowEvent( MouseLeaveWindowEvent obj ) : base( obj )
        {
