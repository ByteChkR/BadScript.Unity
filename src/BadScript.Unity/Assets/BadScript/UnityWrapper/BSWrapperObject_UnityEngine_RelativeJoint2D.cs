...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_RelativeJoint2D : BSWrapperObject < RelativeJoint2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_RelativeJoint2D( RelativeJoint2D obj ) : base( obj )
        {
            m_Properties["maxForce"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxForce ),
                x => m_InternalObject.maxForce = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["maxTorque"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxTorque ),
                x => m_InternalObject.maxTorque = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["correctionScale"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.correctionScale ),
                x => m_InternalObject.correctionScale = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["autoConfigureOffset"] = new BSReflectionReference(
                () => m_InternalObject.autoConfigureOffset ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.autoConfigureOffset = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["linearOffset"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.linearOffset ),
                x => m_InternalObject.linearOffset = WrapperHelper.UnwrapObject < Vector2 >( x ) );

            m_Properties["angularOffset"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.angularOffset ),
                x => m_InternalObject.angularOffset = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["target"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2( m_InternalObject.target ),
                null );
