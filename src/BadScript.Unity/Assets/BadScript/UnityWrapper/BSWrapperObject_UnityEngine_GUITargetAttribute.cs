...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_GUITargetAttribute : BSWrapperObject < GUITargetAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_GUITargetAttribute( GUITargetAttribute obj ) : base( obj )
        {
