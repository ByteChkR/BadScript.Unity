...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_TerrainCollider : BSWrapperObject < TerrainCollider >

    {
        #region Public

        public BSWrapperObject_UnityEngine_TerrainCollider( TerrainCollider obj ) : base( obj )
        {
