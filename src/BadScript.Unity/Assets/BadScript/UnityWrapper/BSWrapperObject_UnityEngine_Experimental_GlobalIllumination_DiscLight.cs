...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_DiscLight : BSWrapperObject < DiscLight >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_DiscLight( DiscLight obj ) : base( obj )
        {
