...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_WheelEvent : BSWrapperObject < WheelEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_WheelEvent( WheelEvent obj ) : base( obj )
        {
            m_Properties["delta"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.delta ),
                null );
