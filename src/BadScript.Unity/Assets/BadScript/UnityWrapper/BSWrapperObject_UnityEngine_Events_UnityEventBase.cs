...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Events_UnityEventBase : BSWrapperObject < UnityEventBase >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Events_UnityEventBase( UnityEventBase obj ) : base( obj )
        {
