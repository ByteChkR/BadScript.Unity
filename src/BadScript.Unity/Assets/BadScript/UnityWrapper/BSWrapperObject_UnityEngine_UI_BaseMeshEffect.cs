...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_BaseMeshEffect : BSWrapperObject < BaseMeshEffect >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_BaseMeshEffect( BaseMeshEffect obj ) : base( obj )
        {
