...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_Image : BSWrapperObject < Image >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_Image( Image obj ) : base( obj )
        {
            ...
            m_Properties["sourceRect"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Rect( m_InternalObject.sourceRect ),
                x => m_InternalObject.sourceRect = WrapperHelper.UnwrapObject < Rect >( x ) );
            ...
            m_Properties["tintColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.tintColor ),
                x => m_InternalObject.tintColor = WrapperHelper.UnwrapObject < Color >( x ) );
