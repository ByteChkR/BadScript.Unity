...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_AimConstraint : BSWrapperObject < AimConstraint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_AimConstraint( AimConstraint obj ) : base( obj )
        {
            ...
            m_Properties["aimVector"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.aimVector ),
                x => m_InternalObject.aimVector = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["upVector"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.upVector ),
                x => m_InternalObject.upVector = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["worldUpVector"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.worldUpVector ),
                x => m_InternalObject.worldUpVector = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["worldUpObject"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Transform( m_InternalObject.worldUpObject ),
                x => m_InternalObject.worldUpObject = WrapperHelper.UnwrapObject < Transform >( x ) );
