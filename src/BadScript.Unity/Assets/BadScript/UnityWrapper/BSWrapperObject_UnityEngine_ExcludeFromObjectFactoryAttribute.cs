...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_ExcludeFromObjectFactoryAttribute : BSWrapperObject <
            ExcludeFromObjectFactoryAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ExcludeFromObjectFactoryAttribute( ExcludeFromObjectFactoryAttribute obj ) :
            base( obj )
        {
