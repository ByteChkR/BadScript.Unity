...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SpriteRenderer : BSWrapperObject < SpriteRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SpriteRenderer( SpriteRenderer obj ) : base( obj )
        {
            ...
            m_Properties["adaptiveModeThreshold"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.adaptiveModeThreshold ),
                x => m_InternalObject.adaptiveModeThreshold = WrapperHelper.UnwrapObject < float >( x ) );
            ...
            m_Properties["flipX"] = new BSReflectionReference(
                () => m_InternalObject.flipX ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.flipX = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["flipY"] = new BSReflectionReference(
                () => m_InternalObject.flipY ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.flipY = WrapperHelper.UnwrapObject < bool >( x ) );
