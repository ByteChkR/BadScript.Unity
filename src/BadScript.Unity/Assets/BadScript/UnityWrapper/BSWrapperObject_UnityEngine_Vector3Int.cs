...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Vector3Int : BSWrapperObject < Vector3Int >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Vector3Int( Vector3Int obj ) : base( obj )
        {
            ...
            m_Properties["Equals"] = new BSFunctionReference(
                new BSFunction(
                    "function Equals(other)",
                    a => m_InternalObject.Equals( WrapperHelper.UnwrapObject < Vector3Int >( a[0] ) )
                        ? BSObject.One
                        : BSObject.Zero,
                    1 ) );
