...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_BindableElement : BSWrapperObject < BindableElement >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_BindableElement( BindableElement obj ) : base( obj )
        {
