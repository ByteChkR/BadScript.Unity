...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_Toggle : BSWrapperObject < Toggle >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_Toggle( Toggle obj ) : base( obj )
        {
            m_Properties["group"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_ToggleGroup( m_InternalObject.group ),
                x => m_InternalObject.group = WrapperHelper.UnwrapObject < ToggleGroup >( x ) );

            m_Properties["isOn"] = new BSReflectionReference(
                () => m_InternalObject.isOn ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.isOn = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["graphic"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_Graphic( m_InternalObject.graphic ),
                x => m_InternalObject.graphic = WrapperHelper.UnwrapObject < Graphic >( x ) );
