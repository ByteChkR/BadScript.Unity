...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_ImageEffectAllowedInSceneView : BSWrapperObject < ImageEffectAllowedInSceneView >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ImageEffectAllowedInSceneView( ImageEffectAllowedInSceneView obj ) : base(
            obj )
        {
