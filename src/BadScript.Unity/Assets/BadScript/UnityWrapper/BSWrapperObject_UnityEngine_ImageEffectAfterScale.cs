...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_ImageEffectAfterScale : BSWrapperObject < ImageEffectAfterScale >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ImageEffectAfterScale( ImageEffectAfterScale obj ) : base( obj )
        {
