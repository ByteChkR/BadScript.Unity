...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_LayoutElement : BSWrapperObject < LayoutElement >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_LayoutElement( LayoutElement obj ) : base( obj )
        {
            m_Properties["ignoreLayout"] = new BSReflectionReference(
                () => m_InternalObject.ignoreLayout ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.ignoreLayout = WrapperHelper.UnwrapObject < bool >( x ) );
