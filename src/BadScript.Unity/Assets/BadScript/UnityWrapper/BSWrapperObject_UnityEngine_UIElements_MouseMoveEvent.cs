...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseMoveEvent : BSWrapperObject < MouseMoveEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseMoveEvent( MouseMoveEvent obj ) : base( obj )
        {
