...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_BillboardRenderer : BSWrapperObject < BillboardRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_BillboardRenderer( BillboardRenderer obj ) : base( obj )
        {
            m_Properties["billboard"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_BillboardAsset( m_InternalObject.billboard ),
                x => m_InternalObject.billboard = WrapperHelper.UnwrapObject < BillboardAsset >( x ) );
