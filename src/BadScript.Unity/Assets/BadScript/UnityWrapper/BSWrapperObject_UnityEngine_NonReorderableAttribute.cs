...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_NonReorderableAttribute : BSWrapperObject < NonReorderableAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_NonReorderableAttribute( NonReorderableAttribute obj ) : base( obj )
        {
