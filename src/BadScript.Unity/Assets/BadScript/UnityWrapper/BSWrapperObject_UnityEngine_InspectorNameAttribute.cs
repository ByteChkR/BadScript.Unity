...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_InspectorNameAttribute : BSWrapperObject < InspectorNameAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_InspectorNameAttribute( InspectorNameAttribute obj ) : base( obj )
        {
