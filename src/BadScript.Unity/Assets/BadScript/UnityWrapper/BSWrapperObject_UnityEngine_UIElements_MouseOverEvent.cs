...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_MouseOverEvent : BSWrapperObject < MouseOverEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseOverEvent( MouseOverEvent obj ) : base( obj )
        {
