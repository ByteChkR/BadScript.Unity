...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Networking_UploadHandler : BSWrapperObject < UploadHandler >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_UploadHandler( UploadHandler obj ) : base( obj )
        {
