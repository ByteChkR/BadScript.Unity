...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_RangeAttribute : BSWrapperObject < RangeAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_RangeAttribute( RangeAttribute obj ) : base( obj )
        {
