...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_MinAttribute : BSWrapperObject < MinAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_MinAttribute( MinAttribute obj ) : base( obj )
        {
