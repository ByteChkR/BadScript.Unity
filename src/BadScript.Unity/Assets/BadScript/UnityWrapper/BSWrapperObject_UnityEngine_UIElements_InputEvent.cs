...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_InputEvent : BSWrapperObject < InputEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_InputEvent( InputEvent obj ) : base( obj )
        {
            m_Properties["previousData"] = new BSReflectionReference(
                () => new BSObject( m_InternalObject.previousData ),
                null );

            m_Properties["newData"] = new BSReflectionReference( () => new BSObject( m_InternalObject.newData ), null );
