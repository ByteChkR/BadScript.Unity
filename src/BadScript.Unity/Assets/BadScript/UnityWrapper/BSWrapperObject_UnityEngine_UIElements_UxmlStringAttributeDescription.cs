...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_UxmlStringAttributeDescription : BSWrapperObject <
            UxmlStringAttributeDescription >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlStringAttributeDescription(
            UxmlStringAttributeDescription obj ) : base( obj )
        {
            ...
            m_Properties["defaultValue"] = new BSReflectionReference(
                () => new BSObject( m_InternalObject.defaultValue ),
                x => m_InternalObject.defaultValue = WrapperHelper.UnwrapObject < string >( x ) );
