...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Networking_MultipartFormFileSection : BSWrapperObject < MultipartFormFileSection >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_MultipartFormFileSection( MultipartFormFileSection obj ) : base(
            obj )
        {
