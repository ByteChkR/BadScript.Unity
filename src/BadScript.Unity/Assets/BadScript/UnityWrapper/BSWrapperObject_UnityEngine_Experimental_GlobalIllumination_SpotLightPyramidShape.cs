...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_SpotLightPyramidShape : BSWrapperObject <
            SpotLightPyramidShape >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_SpotLightPyramidShape(
            SpotLightPyramidShape obj ) : base( obj )
        {
