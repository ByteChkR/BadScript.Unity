...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Networking_Match_NetworkMatch : BSWrapperObject < NetworkMatch >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_Match_NetworkMatch( NetworkMatch obj ) : base( obj )
        {
            m_Properties["baseUri"] = new BSReflectionReference(
                () => new BSWrapperObject_System_Uri( m_InternalObject.baseUri ),
                x => m_InternalObject.baseUri = WrapperHelper.UnwrapObject < Uri >( x ) );
