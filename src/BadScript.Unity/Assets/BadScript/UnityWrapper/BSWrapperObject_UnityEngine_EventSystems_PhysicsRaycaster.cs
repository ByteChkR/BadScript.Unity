...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_EventSystems_PhysicsRaycaster : BSWrapperObject < PhysicsRaycaster >

    {
        #region Public

        public BSWrapperObject_UnityEngine_EventSystems_PhysicsRaycaster( PhysicsRaycaster obj ) : base( obj )
        {
