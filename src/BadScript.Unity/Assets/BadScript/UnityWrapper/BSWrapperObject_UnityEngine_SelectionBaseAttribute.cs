...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SelectionBaseAttribute : BSWrapperObject < SelectionBaseAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SelectionBaseAttribute( SelectionBaseAttribute obj ) : base( obj )
        {
