...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_IMGUIEvent : BSWrapperObject < IMGUIEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_IMGUIEvent( IMGUIEvent obj ) : base( obj )
        {
