...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerOverEvent : BSWrapperObject < PointerOverEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerOverEvent( PointerOverEvent obj ) : base( obj )
        {
