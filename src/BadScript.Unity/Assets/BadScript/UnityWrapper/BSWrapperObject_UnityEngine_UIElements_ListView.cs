...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ListView : BSWrapperObject < ListView >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ListView( ListView obj ) : base( obj )
        {
            m_Properties["itemsSource"] = new BSReflectionReference(
                () => new BSWrapperObject_System_Collections_IList( m_InternalObject.itemsSource ),
                x => m_InternalObject.itemsSource = WrapperHelper.UnwrapObject < IList >( x ) );

            m_Properties["resolvedItemHeight"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.resolvedItemHeight ),
                null );

            m_Properties["itemHeight"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.itemHeight ),
                x => m_InternalObject.itemHeight = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["showBorder"] = new BSReflectionReference(
                () => m_InternalObject.showBorder ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.showBorder = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["reorderable"] = new BSReflectionReference(
                () => m_InternalObject.reorderable ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.reorderable = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["selectedIndex"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.selectedIndex ),
                x => m_InternalObject.selectedIndex = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["selectedItem"] = new BSReflectionReference(
                () => new BSWrapperObject_System_Object( m_InternalObject.selectedItem ),
                null );
            ...
            m_Properties["showBoundCollectionSize"] = new BSReflectionReference(
                () => m_InternalObject.showBoundCollectionSize ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.showBoundCollectionSize = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["horizontalScrollingEnabled"] = new BSReflectionReference(
                () => m_InternalObject.horizontalScrollingEnabled ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.horizontalScrollingEnabled = WrapperHelper.UnwrapObject < bool >( x ) );
