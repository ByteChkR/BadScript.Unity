...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_ExecuteAlways : BSWrapperObject < ExecuteAlways >

    {
        #region Public

        public BSWrapperObject_UnityEngine_ExecuteAlways( ExecuteAlways obj ) : base( obj )
        {
