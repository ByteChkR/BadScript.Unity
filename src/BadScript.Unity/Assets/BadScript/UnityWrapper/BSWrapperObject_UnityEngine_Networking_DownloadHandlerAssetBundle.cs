...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Networking_DownloadHandlerAssetBundle : BSWrapperObject < DownloadHandlerAssetBundle
        >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_DownloadHandlerAssetBundle( DownloadHandlerAssetBundle obj ) :
            base( obj )
        {
