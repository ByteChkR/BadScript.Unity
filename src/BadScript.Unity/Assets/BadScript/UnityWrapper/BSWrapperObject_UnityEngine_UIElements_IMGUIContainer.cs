...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_IMGUIContainer : BSWrapperObject < IMGUIContainer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_IMGUIContainer( IMGUIContainer obj ) : base( obj )
        {
            m_Properties["onGUIHandler"] = new BSReflectionReference(
                () => new BSWrapperObject_System_Action( m_InternalObject.onGUIHandler ),
                x => m_InternalObject.onGUIHandler = WrapperHelper.UnwrapObject < Action >( x ) );

            m_Properties["cullingEnabled"] = new BSReflectionReference(
                () => m_InternalObject.cullingEnabled ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.cullingEnabled = WrapperHelper.UnwrapObject < bool >( x ) );
