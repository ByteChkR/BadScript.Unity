...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_LayoutGroup : BSWrapperObject < LayoutGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_LayoutGroup( LayoutGroup obj ) : base( obj )
        {
