...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_FocusInEvent : BSWrapperObject < FocusInEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_FocusInEvent( FocusInEvent obj ) : base( obj )
        {
