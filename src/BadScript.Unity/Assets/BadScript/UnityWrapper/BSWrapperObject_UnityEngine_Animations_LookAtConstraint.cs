...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_LookAtConstraint : BSWrapperObject < LookAtConstraint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_LookAtConstraint( LookAtConstraint obj ) : base( obj )
        {
            ...
            m_Properties["roll"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.roll ),
                x => m_InternalObject.roll = WrapperHelper.UnwrapObject < float >( x ) );
            ...
            m_Properties["useUpObject"] = new BSReflectionReference(
                () => m_InternalObject.useUpObject ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.useUpObject = WrapperHelper.UnwrapObject < bool >( x ) );
