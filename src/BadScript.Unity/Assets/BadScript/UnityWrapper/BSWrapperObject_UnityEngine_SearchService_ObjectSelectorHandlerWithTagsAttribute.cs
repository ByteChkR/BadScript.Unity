...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_SearchService_ObjectSelectorHandlerWithTagsAttribute : BSWrapperObject <
            ObjectSelectorHandlerWithTagsAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SearchService_ObjectSelectorHandlerWithTagsAttribute(
            ObjectSelectorHandlerWithTagsAttribute obj ) : base( obj )
        {
