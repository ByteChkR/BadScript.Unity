...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_MouseEnterWindowEvent : BSWrapperObject < MouseEnterWindowEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_MouseEnterWindowEvent( MouseEnterWindowEvent obj ) : base( obj )
        {
