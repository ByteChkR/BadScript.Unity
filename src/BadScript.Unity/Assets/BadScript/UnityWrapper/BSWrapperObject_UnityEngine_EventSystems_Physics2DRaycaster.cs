...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_EventSystems_Physics2DRaycaster : BSWrapperObject < Physics2DRaycaster >

    {
        #region Public

        public BSWrapperObject_UnityEngine_EventSystems_Physics2DRaycaster( Physics2DRaycaster obj ) : base( obj )
        {
            ...
            m_Properties["finalEventMask"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.finalEventMask ),
                null );

            m_Properties["eventMask"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_LayerMask( m_InternalObject.eventMask ),
                x => m_InternalObject.eventMask = WrapperHelper.UnwrapObject < LayerMask >( x ) );

            m_Properties["maxRayIntersections"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxRayIntersections ),
                x => m_InternalObject.maxRayIntersections = WrapperHelper.UnwrapObject < int >( x ) );
