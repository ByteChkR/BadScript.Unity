...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_AndroidJavaRunnable : BSWrapperObject < AndroidJavaRunnable >

    {
        #region Public

        public BSWrapperObject_UnityEngine_AndroidJavaRunnable( AndroidJavaRunnable obj ) : base( obj )
        {
