...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DragExitedEvent : BSWrapperObject < DragExitedEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DragExitedEvent( DragExitedEvent obj ) : base( obj )
        {
