...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_ContextualMenuPopulateEvent : BSWrapperObject <
            ContextualMenuPopulateEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ContextualMenuPopulateEvent( ContextualMenuPopulateEvent obj ) :
            base( obj )
        {
            m_Properties["menu"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_DropdownMenu( m_InternalObject.menu ),
                null );

            m_Properties["triggerEvent"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_EventBase( m_InternalObject.triggerEvent ),
                null );
