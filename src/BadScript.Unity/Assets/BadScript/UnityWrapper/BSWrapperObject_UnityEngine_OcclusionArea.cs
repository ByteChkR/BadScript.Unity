...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_OcclusionArea : BSWrapperObject < OcclusionArea >

    {
        #region Public

        public BSWrapperObject_UnityEngine_OcclusionArea( OcclusionArea obj ) : base( obj )
        {
