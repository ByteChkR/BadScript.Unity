...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_UxmlAttributeOverridesFactory : BSWrapperObject <
            UxmlAttributeOverridesFactory >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlAttributeOverridesFactory( UxmlAttributeOverridesFactory obj )
            : base( obj )
        {
