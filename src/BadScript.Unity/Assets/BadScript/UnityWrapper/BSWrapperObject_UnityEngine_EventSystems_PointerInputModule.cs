...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_EventSystems_PointerInputModule : BSWrapperObject < PointerInputModule >

    {
        #region Public

        public BSWrapperObject_UnityEngine_EventSystems_PointerInputModule( PointerInputModule obj ) : base( obj )
        {
