...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ContextClickEvent : BSWrapperObject < ContextClickEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ContextClickEvent( ContextClickEvent obj ) : base( obj )
        {
