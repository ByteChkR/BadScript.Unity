...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Profiling_Experimental_DebugScreenCapture : BSWrapperObject < DebugScreenCapture >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Profiling_Experimental_DebugScreenCapture( DebugScreenCapture obj ) : base(
            obj )
        {
