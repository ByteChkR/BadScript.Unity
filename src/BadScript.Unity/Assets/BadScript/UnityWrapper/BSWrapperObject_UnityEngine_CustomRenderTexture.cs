...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CustomRenderTexture : BSWrapperObject < CustomRenderTexture >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CustomRenderTexture( CustomRenderTexture obj ) : base( obj )
        {
            ...
            m_Properties["initializationMaterial"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Material( m_InternalObject.initializationMaterial ),
                x => m_InternalObject.initializationMaterial = WrapperHelper.UnwrapObject < Material >( x ) );

            m_Properties["initializationTexture"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Texture( m_InternalObject.initializationTexture ),
                x => m_InternalObject.initializationTexture = WrapperHelper.UnwrapObject < Texture >( x ) );

            m_Properties["initializationColor"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Color( m_InternalObject.initializationColor ),
                x => m_InternalObject.initializationColor = WrapperHelper.UnwrapObject < Color >( x ) );

            m_Properties["shaderPass"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.shaderPass ),
                x => m_InternalObject.shaderPass = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["cubemapFaceMask"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.cubemapFaceMask ),
                x => m_InternalObject.cubemapFaceMask = WrapperHelper.UnwrapObject < uint >( x ) );

            m_Properties["doubleBuffered"] = new BSReflectionReference(
                () => m_InternalObject.doubleBuffered ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.doubleBuffered = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["wrapUpdateZones"] = new BSReflectionReference(
                () => m_InternalObject.wrapUpdateZones ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.wrapUpdateZones = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["updatePeriod"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.updatePeriod ),
                x => m_InternalObject.updatePeriod = WrapperHelper.UnwrapObject < float >( x ) );
