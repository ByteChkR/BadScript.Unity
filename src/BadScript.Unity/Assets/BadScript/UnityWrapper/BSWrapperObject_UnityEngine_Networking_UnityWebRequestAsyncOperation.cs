...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Networking_UnityWebRequestAsyncOperation : BSWrapperObject <
            UnityWebRequestAsyncOperation >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_UnityWebRequestAsyncOperation( UnityWebRequestAsyncOperation obj )
            : base( obj )
        {
            m_Properties["webRequest"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Networking_UnityWebRequest( m_InternalObject.webRequest ),
                null );
