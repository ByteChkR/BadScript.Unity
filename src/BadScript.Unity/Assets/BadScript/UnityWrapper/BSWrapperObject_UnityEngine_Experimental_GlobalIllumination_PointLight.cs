...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_PointLight : BSWrapperObject < PointLight >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_PointLight( PointLight obj ) : base( obj )
        {
