...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_MultilineAttribute : BSWrapperObject < MultilineAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_MultilineAttribute( MultilineAttribute obj ) : base( obj )
        {
            ...
            m_Properties["lines"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.lines ),
                null );
