...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_Dropdown : BSWrapperObject < Dropdown >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_Dropdown( Dropdown obj ) : base( obj )
        {
            m_Properties["template"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_RectTransform( m_InternalObject.template ),
                x => m_InternalObject.template = WrapperHelper.UnwrapObject < RectTransform >( x ) );

            m_Properties["captionText"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_Text( m_InternalObject.captionText ),
                x => m_InternalObject.captionText = WrapperHelper.UnwrapObject < Text >( x ) );

            m_Properties["captionImage"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_Image( m_InternalObject.captionImage ),
                x => m_InternalObject.captionImage = WrapperHelper.UnwrapObject < Image >( x ) );

            m_Properties["itemText"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_Text( m_InternalObject.itemText ),
                x => m_InternalObject.itemText = WrapperHelper.UnwrapObject < Text >( x ) );

            m_Properties["itemImage"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UI_Image( m_InternalObject.itemImage ),
                x => m_InternalObject.itemImage = WrapperHelper.UnwrapObject < Image >( x ) );

            m_Properties["alphaFadeSpeed"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.alphaFadeSpeed ),
                x => m_InternalObject.alphaFadeSpeed = WrapperHelper.UnwrapObject < float >( x ) );
