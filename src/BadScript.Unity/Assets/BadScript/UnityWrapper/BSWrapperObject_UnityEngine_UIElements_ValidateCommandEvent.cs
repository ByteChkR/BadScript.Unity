...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ValidateCommandEvent : BSWrapperObject < ValidateCommandEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ValidateCommandEvent( ValidateCommandEvent obj ) : base( obj )
        {
