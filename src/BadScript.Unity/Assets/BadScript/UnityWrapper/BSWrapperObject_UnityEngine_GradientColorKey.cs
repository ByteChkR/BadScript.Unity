...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_GradientColorKey : BSWrapperObject < GradientColorKey >

    {
        #region Public

        public BSWrapperObject_UnityEngine_GradientColorKey( GradientColorKey obj ) : base( obj )
        {
