...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CanvasGroup : BSWrapperObject < CanvasGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CanvasGroup( CanvasGroup obj ) : base( obj )
        {
            ...
            m_Properties["blocksRaycasts"] = new BSReflectionReference(
                () => m_InternalObject.blocksRaycasts ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.blocksRaycasts = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["ignoreParentGroups"] = new BSReflectionReference(
                () => m_InternalObject.ignoreParentGroups ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.ignoreParentGroups = WrapperHelper.UnwrapObject < bool >( x ) );
