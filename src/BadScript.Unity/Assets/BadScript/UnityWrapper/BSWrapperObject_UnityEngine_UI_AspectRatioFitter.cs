...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_AspectRatioFitter : BSWrapperObject < AspectRatioFitter >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_AspectRatioFitter( AspectRatioFitter obj ) : base( obj )
        {
