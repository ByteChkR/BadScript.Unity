...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SparseTexture : BSWrapperObject < SparseTexture >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SparseTexture( SparseTexture obj ) : base( obj )
        {
            m_Properties["tileWidth"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.tileWidth ),
                null );

            m_Properties["tileHeight"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.tileHeight ),
                null );
