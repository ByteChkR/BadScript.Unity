...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_KeyUpEvent : BSWrapperObject < KeyUpEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_KeyUpEvent( KeyUpEvent obj ) : base( obj )
        {
