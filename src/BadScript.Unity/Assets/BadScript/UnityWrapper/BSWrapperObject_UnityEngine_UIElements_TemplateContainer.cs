...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_TemplateContainer : BSWrapperObject < TemplateContainer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_TemplateContainer( TemplateContainer obj ) : base( obj )
        {
            m_Properties["templateId"] = new BSReflectionReference(
                () => new BSObject( m_InternalObject.templateId ),
                null );
