...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CharacterController : BSWrapperObject < CharacterController >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CharacterController( CharacterController obj ) : base( obj )
        {
            ...
            m_Properties["slopeLimit"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.slopeLimit ),
                x => m_InternalObject.slopeLimit = WrapperHelper.UnwrapObject < float >( x ) );

            m_Properties["stepOffset"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.stepOffset ),
                x => m_InternalObject.stepOffset = WrapperHelper.UnwrapObject < float >( x ) );
            ...
            m_Properties["minMoveDistance"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.minMoveDistance ),
                x => m_InternalObject.minMoveDistance = WrapperHelper.UnwrapObject < float >( x ) );
            ...
            m_Properties["enableOverlapRecovery"] = new BSReflectionReference(
                () => m_InternalObject.enableOverlapRecovery ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.enableOverlapRecovery = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["SimpleMove"] = new BSFunctionReference(
                new BSFunction(
                    "function SimpleMove(speed)",
                    a => m_InternalObject.SimpleMove( WrapperHelper.UnwrapObject < Vector3 >( a[0] ) )
                        ? BSObject.One
                        : BSObject.Zero,
                    1 ) );
