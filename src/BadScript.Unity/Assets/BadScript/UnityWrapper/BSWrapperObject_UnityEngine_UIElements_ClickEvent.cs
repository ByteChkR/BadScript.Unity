...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_ClickEvent : BSWrapperObject < ClickEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_ClickEvent( ClickEvent obj ) : base( obj )
        {
