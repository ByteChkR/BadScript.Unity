...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_AssemblyIsEditorAssembly : BSWrapperObject < AssemblyIsEditorAssembly >

    {
        #region Public

        public BSWrapperObject_UnityEngine_AssemblyIsEditorAssembly( AssemblyIsEditorAssembly obj ) : base( obj )
        {
