...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_PositionConstraint : BSWrapperObject < PositionConstraint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_PositionConstraint( PositionConstraint obj ) : base( obj )
        {
            ...
            m_Properties["translationOffset"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.translationOffset ),
                x => m_InternalObject.translationOffset = WrapperHelper.UnwrapObject < Vector3 >( x ) );
