...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_HeaderAttribute : BSWrapperObject < HeaderAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_HeaderAttribute( HeaderAttribute obj ) : base( obj )
        {
            ...
            m_Properties["header"] = new BSReflectionReference( () => new BSObject( m_InternalObject.header ), null );
