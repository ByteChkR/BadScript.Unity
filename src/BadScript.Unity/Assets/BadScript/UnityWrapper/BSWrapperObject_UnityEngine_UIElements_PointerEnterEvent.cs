...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_PointerEnterEvent : BSWrapperObject < PointerEnterEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerEnterEvent( PointerEnterEvent obj ) : base( obj )
        {
