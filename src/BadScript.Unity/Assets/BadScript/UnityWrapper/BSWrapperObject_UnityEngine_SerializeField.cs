...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SerializeField : BSWrapperObject < SerializeField >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SerializeField( SerializeField obj ) : base( obj )
        {
