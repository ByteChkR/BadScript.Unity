...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DetachFromPanelEvent : BSWrapperObject < DetachFromPanelEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DetachFromPanelEvent( DetachFromPanelEvent obj ) : base( obj )
        {
            m_Properties["originPanel"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_IPanel( m_InternalObject.originPanel ),
                null );

            m_Properties["destinationPanel"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_IPanel( m_InternalObject.destinationPanel ),
                null );
