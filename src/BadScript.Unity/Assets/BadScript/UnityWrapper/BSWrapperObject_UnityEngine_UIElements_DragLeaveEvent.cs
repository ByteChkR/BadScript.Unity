...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_DragLeaveEvent : BSWrapperObject < DragLeaveEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_DragLeaveEvent( DragLeaveEvent obj ) : base( obj )
        {
