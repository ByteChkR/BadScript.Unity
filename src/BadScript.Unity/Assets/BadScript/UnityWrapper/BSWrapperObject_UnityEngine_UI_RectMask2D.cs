...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_RectMask2D : BSWrapperObject < RectMask2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_RectMask2D( RectMask2D obj ) : base( obj )
        {
            m_Properties["padding"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector4( m_InternalObject.padding ),
                x => m_InternalObject.padding = WrapperHelper.UnwrapObject < Vector4 >( x ) );

            m_Properties["softness"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector2Int( m_InternalObject.softness ),
                x => m_InternalObject.softness = WrapperHelper.UnwrapObject < Vector2Int >( x ) );

            m_Properties["canvasRect"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Rect( m_InternalObject.canvasRect ),
                null );
