...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_VerticalLayoutGroup : BSWrapperObject < VerticalLayoutGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_VerticalLayoutGroup( VerticalLayoutGroup obj ) : base( obj )
        {
