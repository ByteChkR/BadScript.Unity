...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_MissingReferenceException : BSWrapperObject < MissingReferenceException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_MissingReferenceException( MissingReferenceException obj ) : base( obj )
        {
