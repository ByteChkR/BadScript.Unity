...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_HideInInspector : BSWrapperObject < HideInInspector >

    {
        #region Public

        public BSWrapperObject_UnityEngine_HideInInspector( HideInInspector obj ) : base( obj )
        {
