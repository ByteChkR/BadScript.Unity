...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_Mask : BSWrapperObject < Mask >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_Mask( Mask obj ) : base( obj )
        {
            ...
            m_Properties["showMaskGraphic"] = new BSReflectionReference(
                () => m_InternalObject.showMaskGraphic ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.showMaskGraphic = WrapperHelper.UnwrapObject < bool >( x ) );
