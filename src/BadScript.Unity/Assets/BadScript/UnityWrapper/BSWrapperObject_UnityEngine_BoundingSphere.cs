...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_BoundingSphere : BSWrapperObject < BoundingSphere >

    {
        #region Public

        public BSWrapperObject_UnityEngine_BoundingSphere( BoundingSphere obj ) : base( obj )
        {
