...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SoftJointLimitSpring : BSWrapperObject < SoftJointLimitSpring >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SoftJointLimitSpring( SoftJointLimitSpring obj ) : base( obj )
        {
