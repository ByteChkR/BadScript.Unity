...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Animations_ParentConstraint : BSWrapperObject < ParentConstraint >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Animations_ParentConstraint( ParentConstraint obj ) : base( obj )
        {
            ...
            m_Properties["translationAtRest"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.translationAtRest ),
                x => m_InternalObject.translationAtRest = WrapperHelper.UnwrapObject < Vector3 >( x ) );
            ...
            m_Properties["GetTranslationOffset"] = new BSFunctionReference(
                new BSFunction(
                    "function GetTranslationOffset(index)",
                    a => new BSWrapperObject_UnityEngine_Vector3(
                        m_InternalObject.GetTranslationOffset( WrapperHelper.UnwrapObject < int >( a[0] ) ) ),
                    1 ) );

            m_Properties["GetRotationOffset"] = new BSFunctionReference(
                new BSFunction(
                    "function GetRotationOffset(index)",
                    a => new BSWrapperObject_UnityEngine_Vector3(
                        m_InternalObject.GetRotationOffset( WrapperHelper.UnwrapObject < int >( a[0] ) ) ),
                    1 ) );
