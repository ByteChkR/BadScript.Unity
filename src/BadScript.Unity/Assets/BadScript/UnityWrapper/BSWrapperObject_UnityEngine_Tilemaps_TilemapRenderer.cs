...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Tilemaps_TilemapRenderer : BSWrapperObject < TilemapRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Tilemaps_TilemapRenderer( TilemapRenderer obj ) : base( obj )
        {
            m_Properties["chunkSize"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3Int( m_InternalObject.chunkSize ),
                x => m_InternalObject.chunkSize = WrapperHelper.UnwrapObject < Vector3Int >( x ) );

            m_Properties["chunkCullingBounds"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Vector3( m_InternalObject.chunkCullingBounds ),
                x => m_InternalObject.chunkCullingBounds = WrapperHelper.UnwrapObject < Vector3 >( x ) );

            m_Properties["maxChunkCount"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxChunkCount ),
                x => m_InternalObject.maxChunkCount = WrapperHelper.UnwrapObject < int >( x ) );

            m_Properties["maxFrameAge"] = new BSReflectionReference(
                () => new BSObject( ( decimal ) m_InternalObject.maxFrameAge ),
                x => m_InternalObject.maxFrameAge = WrapperHelper.UnwrapObject < int >( x ) );
