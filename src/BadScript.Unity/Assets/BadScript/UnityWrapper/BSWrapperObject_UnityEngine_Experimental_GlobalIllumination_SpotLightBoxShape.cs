...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_SpotLightBoxShape : BSWrapperObject <
            SpotLightBoxShape >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Experimental_GlobalIllumination_SpotLightBoxShape( SpotLightBoxShape obj ) :
            base( obj )
        {
