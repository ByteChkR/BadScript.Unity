...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_ContentSizeFitter : BSWrapperObject < ContentSizeFitter >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_ContentSizeFitter( ContentSizeFitter obj ) : base( obj )
        {
