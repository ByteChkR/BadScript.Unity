...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_Networking_UploadHandlerRaw : BSWrapperObject < UploadHandlerRaw >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Networking_UploadHandlerRaw( UploadHandlerRaw obj ) : base( obj )
        {
