...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_Scripting_AlwaysLinkAssemblyAttribute : BSWrapperObject <
            AlwaysLinkAssemblyAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_Scripting_AlwaysLinkAssemblyAttribute( AlwaysLinkAssemblyAttribute obj ) :
            base( obj )
        {
