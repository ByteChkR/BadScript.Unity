...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UI_HorizontalOrVerticalLayoutGroup : BSWrapperObject <
            HorizontalOrVerticalLayoutGroup >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_HorizontalOrVerticalLayoutGroup( HorizontalOrVerticalLayoutGroup obj ) :
            base( obj )
        {
