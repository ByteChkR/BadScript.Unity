...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UI_PositionAsUV1 : BSWrapperObject < PositionAsUV1 >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UI_PositionAsUV1( PositionAsUV1 obj ) : base( obj )
        {
