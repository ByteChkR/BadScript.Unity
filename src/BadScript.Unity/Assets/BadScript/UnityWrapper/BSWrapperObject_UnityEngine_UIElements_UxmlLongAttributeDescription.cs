...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_UxmlLongAttributeDescription : BSWrapperObject <
            UxmlLongAttributeDescription >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlLongAttributeDescription( UxmlLongAttributeDescription obj ) :
            base( obj )
        {
            ...
            m_Properties["defaultValue"] = new BSReflectionReference(
                ...
                x => m_InternalObject.defaultValue = WrapperHelper.UnwrapObject < long >( x ) );
