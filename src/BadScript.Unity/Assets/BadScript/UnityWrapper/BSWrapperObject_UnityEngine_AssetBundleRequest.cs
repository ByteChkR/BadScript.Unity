...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_AssetBundleRequest : BSWrapperObject < AssetBundleRequest >

    {
        #region Public

        public BSWrapperObject_UnityEngine_AssetBundleRequest( AssetBundleRequest obj ) : base( obj )
        {
