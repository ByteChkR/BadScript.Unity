...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_BeforeRenderOrderAttribute : BSWrapperObject < BeforeRenderOrderAttribute >

    {
        #region Public

        public BSWrapperObject_UnityEngine_BeforeRenderOrderAttribute( BeforeRenderOrderAttribute obj ) : base( obj )
        {
