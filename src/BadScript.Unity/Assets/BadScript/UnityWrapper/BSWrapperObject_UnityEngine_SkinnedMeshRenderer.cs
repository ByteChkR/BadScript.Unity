...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_SkinnedMeshRenderer : BSWrapperObject < SkinnedMeshRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_SkinnedMeshRenderer( SkinnedMeshRenderer obj ) : base( obj )
        {
            m_Properties["updateWhenOffscreen"] = new BSReflectionReference(
                () => m_InternalObject.updateWhenOffscreen ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.updateWhenOffscreen = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["forceMatrixRecalculationPerRender"] = new BSReflectionReference(
                () => m_InternalObject.forceMatrixRecalculationPerRender ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.forceMatrixRecalculationPerRender = WrapperHelper.UnwrapObject < bool >( x ) );

            m_Properties["rootBone"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_Transform( m_InternalObject.rootBone ),
                x => m_InternalObject.rootBone = WrapperHelper.UnwrapObject < Transform >( x ) );
            ...
            m_Properties["skinnedMotionVectors"] = new BSReflectionReference(
                () => m_InternalObject.skinnedMotionVectors ? BSObject.One : BSObject.Zero,
                x => m_InternalObject.skinnedMotionVectors = WrapperHelper.UnwrapObject < bool >( x ) );
            ...
            m_Properties["GetBlendShapeWeight"] = new BSFunctionReference(
                new BSFunction(
                    "function GetBlendShapeWeight(index)",
                    a => new BSObject(
                        ( decimal ) m_InternalObject.GetBlendShapeWeight(
