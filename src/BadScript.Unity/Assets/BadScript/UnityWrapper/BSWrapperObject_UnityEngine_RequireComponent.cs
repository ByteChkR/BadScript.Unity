...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_RequireComponent : BSWrapperObject < RequireComponent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_RequireComponent( RequireComponent obj ) : base( obj )
        {
