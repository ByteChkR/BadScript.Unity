...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_UxmlTemplateFactory : BSWrapperObject < UxmlTemplateFactory >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlTemplateFactory( UxmlTemplateFactory obj ) : base( obj )
        {
