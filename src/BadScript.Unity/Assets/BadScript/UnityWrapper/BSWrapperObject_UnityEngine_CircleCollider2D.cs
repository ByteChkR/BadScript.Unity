...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_CircleCollider2D : BSWrapperObject < CircleCollider2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_CircleCollider2D( CircleCollider2D obj ) : base( obj )
        {
