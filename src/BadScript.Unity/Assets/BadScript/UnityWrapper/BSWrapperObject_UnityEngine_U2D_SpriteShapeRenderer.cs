...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_U2D_SpriteShapeRenderer : BSWrapperObject < SpriteShapeRenderer >

    {
        #region Public

        public BSWrapperObject_UnityEngine_U2D_SpriteShapeRenderer( SpriteShapeRenderer obj ) : base( obj )
        {
