...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_MissingComponentException : BSWrapperObject < MissingComponentException >

    {
        #region Public

        public BSWrapperObject_UnityEngine_MissingComponentException( MissingComponentException obj ) : base( obj )
        {
