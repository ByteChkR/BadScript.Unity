...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_PointerCaptureOutEvent : BSWrapperObject < PointerCaptureOutEvent >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_PointerCaptureOutEvent( PointerCaptureOutEvent obj ) : base( obj )
        {
