...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class
        BSWrapperObject_UnityEngine_UIElements_UxmlFloatAttributeDescription : BSWrapperObject <
            UxmlFloatAttributeDescription >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_UxmlFloatAttributeDescription( UxmlFloatAttributeDescription obj )
            : base( obj )
        {
            ...
            m_Properties["defaultValue"] = new BSReflectionReference(
                ...
                x => m_InternalObject.defaultValue = WrapperHelper.UnwrapObject < float >( x ) );
