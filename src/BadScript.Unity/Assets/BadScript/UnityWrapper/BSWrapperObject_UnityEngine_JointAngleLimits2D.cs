...
namespace BSWrapperObjects.Internal.UnityWrapper
{
    ...
    public class BSWrapperObject_UnityEngine_JointAngleLimits2D : BSWrapperObject < JointAngleLimits2D >

    {
        #region Public

        public BSWrapperObject_UnityEngine_JointAngleLimits2D( JointAngleLimits2D obj ) : base( obj )
        {
