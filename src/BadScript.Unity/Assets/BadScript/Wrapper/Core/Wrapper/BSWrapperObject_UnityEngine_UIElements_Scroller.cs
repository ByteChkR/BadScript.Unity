...
namespace BadScript.Unity.Wrapper.Core.Generated
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_Scroller : BSWrapperObject < Scroller >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_Scroller( Scroller obj ) : base( obj )
        {
            m_Properties["slider"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_Slider( m_InternalObject.slider ),
                null );

            m_Properties["lowButton"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_RepeatButton( m_InternalObject.lowButton ),
                null );

            m_Properties["highButton"] = new BSReflectionReference(
                () => new BSWrapperObject_UnityEngine_UIElements_RepeatButton( m_InternalObject.highButton ),
                null );
            ...
            m_Properties["Adjust"] = new BSFunctionReference(
                new BSFunction(
                    "function Adjust(factor)",
                    a =>
                    {
                        m_InternalObject.Adjust( WrapperHelper.UnwrapObject < float >( a[0] ) );

                        return new BSObject( null );
                    },
                    1 ) );

            m_Properties["ScrollPageUp"] = new BSFunctionReference(
                new BSFunction(
            ...
            m_Properties["ScrollPageDown"] = new BSFunctionReference(
                new BSFunction(
            ...
            m_Properties["ScrollPageUp"] = new BSFunctionReference(
                new BSFunction(
                    "function ScrollPageUp(factor)",
                    a =>
                    {
                        m_InternalObject.ScrollPageUp( WrapperHelper.UnwrapObject < float >( a[0] ) );
            ...
            m_Properties["ScrollPageDown"] = new BSFunctionReference(
                new BSFunction(
                    "function ScrollPageDown(factor)",
                    a =>
                    {
                        m_InternalObject.ScrollPageDown( WrapperHelper.UnwrapObject < float >( a[0] ) );
