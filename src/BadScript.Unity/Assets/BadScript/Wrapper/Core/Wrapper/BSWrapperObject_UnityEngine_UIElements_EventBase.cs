...
namespace BadScript.Unity.Wrapper.Core.Generated
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_EventBase : BSWrapperObject < EventBase >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_EventBase( EventBase obj ) : base( obj )
        {
            ...
            m_Properties["StopPropagation"] = new BSFunctionReference(
                new BSFunction(
            ...
            m_Properties["StopImmediatePropagation"] = new BSFunctionReference(
                new BSFunction(
            ...
            m_Properties["PreventDefault"] = new BSFunctionReference(
                new BSFunction(
