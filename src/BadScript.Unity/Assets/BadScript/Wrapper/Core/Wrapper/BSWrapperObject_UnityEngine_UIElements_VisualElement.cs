...
namespace BadScript.Unity.Wrapper.Core.Generated
{
    ...
    public class BSWrapperObject_UnityEngine_UIElements_VisualElement : BSWrapperObject < VisualElement >

    {
        #region Public

        public BSWrapperObject_UnityEngine_UIElements_VisualElement( VisualElement obj ) : base( obj )
        {
