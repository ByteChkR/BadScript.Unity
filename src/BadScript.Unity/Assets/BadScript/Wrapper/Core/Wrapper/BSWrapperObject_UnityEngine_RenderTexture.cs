...
namespace BadScript.Unity.Wrapper.Core.Generated
{
    ...
    public class BSWrapperObject_UnityEngine_RenderTexture : BSWrapperObject<UnityEngine.RenderTexture>

    {
        public BSWrapperObject_UnityEngine_RenderTexture(UnityEngine.RenderTexture obj) : base(obj)
        {
            ...
            m_Properties["sRGB"] = new BSReflectionReference(() => m_InternalObject.sRGB ? BSObject.One : BSObject.Zero, null);
            ...
            m_Properties["antiAliasing"] = new BSReflectionReference(() => new BSObject((decimal)m_InternalObject.antiAliasing), x=> m_InternalObject.antiAliasing = WrapperHelper.UnwrapObject<System.Int32>(x));
            m_Properties["bindTextureMS"] = new BSReflectionReference(() => m_InternalObject.bindTextureMS ? BSObject.One : BSObject.Zero, x=> m_InternalObject.bindTextureMS = WrapperHelper.UnwrapObject<System.Boolean>(x));
            ...
            m_Properties["isPowerOfTwo"] = new BSReflectionReference(() => m_InternalObject.isPowerOfTwo ? BSObject.One : BSObject.Zero, x=> m_InternalObject.isPowerOfTwo = WrapperHelper.UnwrapObject<System.Boolean>(x));
            m_Properties["colorBuffer"] = new BSReflectionReference(() => new BSWrapperObject_UnityEngine_RenderBuffer(m_InternalObject.colorBuffer), null);
            m_Properties["depthBuffer"] = new BSReflectionReference(() => new BSWrapperObject_UnityEngine_RenderBuffer(m_InternalObject.depthBuffer), null);
            ...
            m_Properties["descriptor"] = new BSReflectionReference(() => new BSWrapperObject_UnityEngine_RenderTextureDescriptor(m_InternalObject.descriptor), x=> m_InternalObject.descriptor = WrapperHelper.UnwrapObject<UnityEngine.RenderTextureDescriptor>(x));
            m_Properties["generateMips"] = new BSReflectionReference(() => m_InternalObject.autoGenerateMips ? BSObject.One : BSObject.Zero, x=> m_InternalObject.autoGenerateMips = WrapperHelper.UnwrapObject<System.Boolean>(x));
            m_Properties["isCubemap"] = new BSReflectionReference(() => m_InternalObject.isCubemap ? BSObject.One : BSObject.Zero, x=> m_InternalObject.isCubemap = WrapperHelper.UnwrapObject<System.Boolean>(x));
            m_Properties["isVolume"] = new BSReflectionReference(() => m_InternalObject.isVolume ? BSObject.One : BSObject.Zero, x=> m_InternalObject.isVolume = WrapperHelper.UnwrapObject<System.Boolean>(x));
            ...
            m_Properties["GetNativeDepthBufferPtr"] = new BSFunctionReference(new BSFunction("function GetNativeDepthBufferPtr()", a => new BSWrapperObject_System_IntPtr(m_InternalObject.GetNativeDepthBufferPtr()), 0));
            m_Properties["DiscardContents"] = new BSFunctionReference(new BSFunction("function DiscardContents(discardColor, discardDepth)", a => {
                m_InternalObject.DiscardContents(WrapperHelper.UnwrapObject<System.Boolean>(a[0]), WrapperHelper.UnwrapObject<System.Boolean>(a[1]));
                return new BSObject(null);
            }, 2));
            m_Properties["MarkRestoreExpected"] = new BSFunctionReference(new BSFunction("function MarkRestoreExpected()", a => {
                m_InternalObject.MarkRestoreExpected();
                return new BSObject(null);
            }, 0));
            m_Properties["DiscardContents"] = new BSFunctionReference(new BSFunction("function DiscardContents()", a => {
                m_InternalObject.DiscardContents();
                return new BSObject(null);
            }, 0));
            m_Properties["ResolveAntiAliasedSurface"] = new BSFunctionReference(new BSFunction("function ResolveAntiAliasedSurface()", a => {
                m_InternalObject.ResolveAntiAliasedSurface();
                return new BSObject(null);
            }, 0));
            m_Properties["ResolveAntiAliasedSurface"] = new BSFunctionReference(new BSFunction("function ResolveAntiAliasedSurface(target)", a => {
                m_InternalObject.ResolveAntiAliasedSurface(WrapperHelper.UnwrapObject<UnityEngine.RenderTexture>(a[0]));
                return new BSObject(null);
            }, 1));
            m_Properties["SetGlobalShaderProperty"] = new BSFunctionReference(new BSFunction("function SetGlobalShaderProperty(propertyName)", a => {
                m_InternalObject.SetGlobalShaderProperty(WrapperHelper.UnwrapObject<System.String>(a[0]));
                return new BSObject(null);
            }, 1));
            m_Properties["Create"] = new BSFunctionReference(new BSFunction("function Create()", a => m_InternalObject.Create() ? BSObject.One : BSObject.Zero, 0));
            m_Properties["Release"] = new BSFunctionReference(new BSFunction("function Release()", a => {
                m_InternalObject.Release();
                return new BSObject(null);
            }, 0));
            m_Properties["IsCreated"] = new BSFunctionReference(new BSFunction("function IsCreated()", a => m_InternalObject.IsCreated() ? BSObject.One : BSObject.Zero, 0));
            m_Properties["GenerateMips"] = new BSFunctionReference(new BSFunction("function GenerateMips()", a => {
                m_InternalObject.GenerateMips();
                return new BSObject(null);
            }, 0));
            m_Properties["GetTexelOffset"] = new BSFunctionReference(new BSFunction("function GetTexelOffset()", a => new BSWrapperObject_UnityEngine_Vector2(m_InternalObject.GetTexelOffset()), 0));
