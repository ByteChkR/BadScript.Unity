...
namespace BadScript.Unity.Wrapper.Core.Generated
{
...

    {
        ...
        public BSWrapperObject_UnityEngine_UIElements_Slider( Slider obj ) : base( obj )
        {
            ...
            m_Properties["AdjustDragElement"] = new BSFunctionReference(
                new BSFunction(
                    "function AdjustDragElement(factor)",
                    a =>
                    {
                        m_InternalObject.AdjustDragElement( WrapperHelper.UnwrapObject < float >( a[0] ) );
